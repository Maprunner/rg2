...
//------------------------------------------------------------------------------
function convertLLtoUTM($lat, $lon, $proj=null){
...
//------------------------------------------------------------------------------
function convertUTMtoLL($north, $east, $zone=null, $southern_hemisphere=false){
...
//------------------------------------------------------------------------------
function convertABCDEF_UTMtoWGS84($inA, $inB, $inC, $inD, $inE, $inF, $zone=null, $southern_hemisphere=false) {
