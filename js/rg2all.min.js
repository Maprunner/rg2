...
function Animation(){"use strict";this.runners=[],this.timer=null,this.animationSecs=0,this.deltaSecs=5,this.timerInterval=100,this.realTime=!1,this.earliestStartSecs=0,this.latestFinishSecs=0,this.tailLength=0,this.useFullTails=!1,this.massStartControl=0,this.massStartByControl=!1,this.displayNames=!0,this.displayInitials=!1}function Controls(){this.controls=[],this.displayControls=!1}function Control(a,b,c){this.code=a,this.x=b,this.y=c}function Courses(){this.courses=[],this.totaltracks=0,this.numberofcourses=0,this.highestControlNumber=0}function Course(a,b){this.name=a.name,this.trackcount=0,this.display=!1,this.courseid=a.courseid,this.codes=a.codes,this.x=a.xpos,this.y=a.ypos,this.isScoreCourse=b,this.resultcount=0}function Draw(){this.trackColor="#ff0000",this.HANDLE_DOT_RADIUS=7,this.hasResults=!1,this.initialiseDrawing()}function RouteData(){this.courseid=null,this.coursename=null,this.resultid=null,this.isScoreCourse=!1,this.eventid=null,this.name=null,this.comments=null,this.x=[],this.y=[],this.controlx=[],this.controly=[],this.time=[],this.startsecs=0,this.totaltime=0}function Events(){this.events=[],this.activeEventID=null}function Event(a){switch(this.kartatid=parseInt(a.id,10),this.mapid=a.mapid,this.format=parseInt(a.format,10),this.name=a.name,this.date=a.date,this.club=a.club,this.mapfilename=void 0===a.suffix?this.mapid+".jpg":this.mapid+"."+a.suffix,this.worldFile=[],"undefined"==typeof a.A?this.georeferenced=!1:(this.georeferenced=!0,this.worldFile.A=a.A,this.worldFile.B=a.B,this.worldFile.C=a.C,this.worldFile.D=a.D,this.worldFile.E=a.E,this.worldFile.F=a.F),this.rawtype=a.type,a.type){case"I":this.type="International event";break;case"N":this.type="National event";break;case"R":this.type="Regional event";break;case"L":this.type="Local event";break;case"T":this.type="Training event";break;default:this.type="Unknown"}this.comment=a.comment,this.courses=0}function GPSTrack(){this.lat=[],this.lon=[],this.time=[],this.baseX=[],this.baseY=[],this.handles=[],this.savedBaseX=[],this.savedBaseY=[],this.savedHandles=[],this.fileLoaded=!1,this.fileName="",this.routeData=new RouteData}function Results(){this.results=[]}function Result(a,b,c,d,e){this.resultid=a.resultid,this.isScoreEvent=b,this.isGPSTrack=this.resultid>=rg2.config.GPS_RESULT_OFFSET?!0:!1,this.name=he.decode(a.name),this.initials=this.getInitials(this.name),this.starttime=a.starttime,this.time=a.time,this.comments=null!==a.comments?he.decode(a.comments):"",this.coursename=a.coursename,""===this.coursename&&(this.coursename=a.courseid),this.courseid=a.courseid,this.splits=a.splits,this.splits.splice(0,0,0),""!==a.scoreref&&(this.scorex=d,this.scorey=e,this.scorecodes=c),this.cumulativeDistance=[],this.hasValidTrack=!1,this.displayTrack=!1,this.displayScoreCourse=!1,this.trackColour=null,this.trackx=[],this.tracky=[],this.speedColour=[],this.xysecs=[],this.isGPSTrack&&(this.time=rg2.getTimeForID(this.resultid-rg2.config.GPS_RESULT_OFFSET),this.time===rg2.config.TIME_NOT_FOUND&&(this.time=a.time),this.splits=rg2.getSplitsForID(this.resultid-rg2.config.GPS_RESULT_OFFSET)),this.legpos=[],a.gpsx.length>0&&this.addTrack(a)}function Runner(a){var b,c;b=rg2.getFullResult(a),this.name=b.name,this.initials=b.initials,this.runnerid=a,this.starttime=b.starttime,this.splits=b.splits,this.legpos=b.legpos,this.colour=null===b.trackColour?rg2.getNextRouteColour():b.trackColour,b.isScoreEvent?(c={},c.name=b.coursename,c.x=b.scorex,c.y=b.scorey,c.codes=b.scorecodes):c=rg2.getCourseDetails(b.courseid),this.coursename=c.name,this.nextStopTime=rg2.config.VERY_HIGH_TIME_IN_SECS,this.x=[],this.y=[],this.legTrackDistance=[],this.cumulativeTrackDistance=[];var d=[];this.x[0]=c.x[0],this.y[0]=c.y[0];var e,f,g,h,i,j,k,l,m,n,o,p,q,r=0,s=0,t=0,u=0,v=c.x[0],w=c.y[0];if(b.hasValidTrack)for(this.x[0]=b.trackx[0],this.y[0]=b.tracky[0],d[0]=0,v=b.trackx[0],w=b.tracky[0],g=0,o=0,n=1;n<b.xysecs.length;n+=1){for(e=b.trackx[n],f=b.tracky[n],h=e-v,i=f-w,o+=Math.sqrt((e-v)*(e-v)+(f-w)*(f-w)),k=o-g,t=b.xysecs[n],j=t-u,m=u+1;t>m;m+=1)this.x[m]=Math.round(v+(m-u)*h/j),this.y[m]=Math.round(w+(m-u)*i/j),d[m]=Math.round(g+(m-u)*k/j);this.x[t]=e,this.y[t]=f,d[t]=o,v=e,w=f,g=o,u=t}else for(this.x[0]=c.x[0],this.y[0]=c.y[0],d[0]=0,v=c.x[0],w=c.y[0],g=0,o=0,l=1;l<c.codes.length;l+=1){for(e=c.x[l],f=c.y[l],h=e-v,i=f-w,o+=Math.sqrt((e-v)*(e-v)+(f-w)*(f-w)),k=o-g,s=b.splits[l],j=s-r,m=r+1;s>m;m+=1)this.x[m]=Math.round(v+(m-r)*h/j),this.y[m]=Math.round(w+(m-r)*i/j),d[m]=Math.round(g+(m-u)*k/j);this.x[s]=e,this.y[s]=f,d[s]=o,v=e,w=f,g=o,r=s}if(this.legTrackDistance[0]=0,this.cumulativeTrackDistance[0]=0,p=d.length-1,"undefined"!=typeof c.codes)if(b.splits!==rg2.config.SPLITS_NOT_FOUND)for(l=1;l<c.codes.length;l+=1)q=b.splits[l]<=p?b.splits[l]:p,this.cumulativeTrackDistance[l]=Math.round(d[q]),this.legTrackDistance[l]=this.cumulativeTrackDistance[l]-this.cumulativeTrackDistance[l-1];else this.legTrackDistance[1]=Math.round(d[p]),this.cumulativeTrackDistance[1]=Math.round(d[p]);b=0,c=0}var rg2=function(){"use strict";function a(){this.colours=["#ff0000","#ff8000","#ff00ff","#ff0080","#008080","#008000","#00ff00","#0080ff","#0000ff","#8000ff","#00ffff","#808080"],this.colourIndex=0}function b(){$("#rg2-container").hide(),"undefined"==typeof rg2Config.dictionary?(vb={},vb.code="en"):vb=rg2Config.dictionary,f(),Wb=$("#rg2-info-panel"),Xb=$("#rg2-event-title"),$.ajaxSetup({cache:!1}),Vb=0!==$("#rg2-manage-login").length?!0:!1,Tb=window.location.hash,Tb&&!Vb&&(Ub=parseInt(Tb.replace("#",""),10)),$("#btn-save-route").button().button("disable"),$("#btn-save-gps-route").button().button("disable"),$("#btn-reset-drawing").button().button("disable"),$("#btn-undo").button().button("disable"),$("#btn-undo-gps-adjust").button().button("disable"),$("#rg2-load-gps-file").button().button("disable"),$("#btn-three-seconds").button().button("disable"),Wb.tabs({disabled:[$b.TAB_COURSES,$b.TAB_RESULTS,$b.TAB_DRAW],active:$b.TAB_EVENTS,heightStyle:"content",activate:function(){n()}}),$("#rg2-result-list").accordion({collapsible:!0,heightStyle:"content",select:function(a,b){console.log("Result index selected: "+b.item[0].id)}}),$("#rg2-clock").text("00:00:00"),$("#rg2-clock-slider").slider({slide:function(a,b){Db.clockSliderMoved(b.value)}}),$("#btn-mass-start").addClass("active"),$("#btn-real-time").removeClass("active"),wb=new Image,yb=new Events,zb=new Courses,Cb=new a,Ab=new Results,Bb=new Controls,Db=new Animation,Fb=new Draw,Lb=null,Mb=!0,Gb=!0,$("#rg2-header-container").css("color",rg2Config.header_text_colour),$("#rg2-header-container").css("background",rg2Config.header_colour),$("#rg2-about-dialog").hide(),$("#rg2-splits-display").hide(),$("#rg2-track-names").hide(),$("#rg2-add-new-event").hide(),$("#rg2-load-progress-bar").progressbar({value:!1}),$("#rg2-load-progress-label").text(""),$("#rg2-load-progress").hide(),$("#btn-about").click(function(){p()}),$("#rg2-resize-info").click(function(){s()}),$("#rg2-hide-info-panel-control").click(function(){s()}),$("#btn-mass-start").click(function(){Db.setReplayType($b.MASS_START_REPLAY)}),$("#btn-real-time").click(function(){Db.setReplayType($b.REAL_TIME_REPLAY)}),$("#rg2-control-select").prop("disabled",!0).click(function(){Db.setStartControl($("#rg2-control-select").val())}),$("#rg2-name-select").prop("disabled",!0).click(function(){Fb.setName(parseInt($("#rg2-name-select").val(),10))}),$("#rg2-course-select").click(function(){Fb.setCourse(parseInt($("#rg2-course-select").val(),10))}),$("#rg2-enter-name").click(function(){Fb.setNameAndTime()}).keyup(function(){Fb.setNameAndTime()}),$("#rg2-new-comments").focus(function(){var a=$("#rg2-new-comments").val();a===d($b.DEFAULT_NEW_COMMENT)&&$("#rg2-new-comments").val("")}),c(),$("#rg2-option-controls").hide(),$("#spn-map-intensity").spinner({max:100,min:0,step:10,numberFormat:"n",spin:function(a,b){_b.mapIntensity=b.value,o(!1)}}).val(_b.mapIntensity),$("#spn-route-intensity").spinner({max:100,min:0,step:10,numberFormat:"n",spin:function(a,b){_b.routeIntensity=b.value,o(!1)}}).val(_b.routeIntensity),$("#spn-name-font-size").spinner({max:30,min:5,step:1,numberFormat:"n",spin:function(a,b){_b.replayFontSize=b.value,o(!1)}}).val(_b.replayFontSize),$("#spn-course-width").spinner({max:10,min:1,step:.5,spin:function(a,b){_b.courseWidth=b.value,o(!1)}}).val(_b.courseWidth),$("#spn-route-width").spinner({max:10,min:1,step:.5,spin:function(a,b){_b.routeWidth=b.value,o(!1)}}).val(_b.routeWidth),$("#spn-control-circle").spinner({max:50,min:3,step:1,spin:function(a,b){_b.circleSize=b.value,o(!1)}}).val(_b.circleSize),$("#chk-snap-toggle").prop("checked",_b.snap).click(function(a){_b.snap=a.target.checked?!0:!1}),$("#chk-show-three-seconds").prop("checked",_b.showGPSSpeed).click(function(){o(!1)}),$("#chk-show-GPS-speed").prop("checked",_b.showGPSSpeed).click(function(){o(!1)}),$("#btn-options").click(function(){q()}),$("#rg2-select-language").click(function(){var a;a=$("#rg2-select-language").val(),a!==vb.code&&("en"===a?(vb={},vb.code="en",h()):g(a))}),$("#rg2-animation-controls").hide(),$("#btn-save-route").button().click(function(){Fb.saveRoute()}),$("#btn-save-gps-route").button().click(function(){Fb.saveGPSRoute()}),$("#btn-move-all").prop("checked",!1),$("#btn-undo").click(function(){Fb.undoLastPoint()}),$("#btn-undo-gps-adjust").click(function(){Fb.undoGPSAdjust()}),$("#btn-reset-drawing").click(function(){Fb.resetDrawing()}),$("#btn-three-seconds").click(function(){Fb.waitThreeSeconds()}),$("#rg2-load-gps-file").change(function(a){Fb.uploadGPS(a)}),$("#btn-zoom-in").click(function(){dc(1)}),$("#btn-reset").click(function(){l()}),$("#btn-zoom-out").click(function(){dc(-1)}),$("#btn-start-stop").click(function(){Db.toggleAnimation()}),$("#btn-faster").click(function(){Db.goFaster()}),$("#btn-slower").click(function(){Db.goSlower()}),$("#btn-toggle-names").click(function(){Db.toggleNameDisplay(),o(!1)}).hide(),$("#rg2-splitsbrowser").hide(),$("#btn-show-splits").click(function(){$("#rg2-splits-table").empty().append(Db.getSplitsTable()).dialog({width:"auto",buttons:{Ok:function(){$(this).dialog("close")}}})}),$("#btn-show-splits").hide(),$("#btn-toggle-controls").click(function(){Bb.toggleControlDisplay(),o(!1)}).hide(),$("#spn-tail-length").spinner({max:600,min:0,spin:function(a,b){Db.setTailLength(b.value)}}).val(0),$("#btn-full-tails").prop("checked",!1).click(function(a){a.target.checked?(Db.setFullTails(!0),$("#spn-tail-length").spinner("disable")):(Db.setFullTails(!1),$("#spn-tail-length").spinner("enable"))}),Vb?(Eb=new Manager(rg2Config.keksi),$("#rg2-animation-controls").hide(),$("#rg2-create-tab").hide(),$("#rg2-edit-tab").hide(),$("#rg2-map-tab").hide(),$("#rg2-manage-login").show(),Wb.tabs("disable",$b.TAB_EVENTS),$("#rg2-draw-tab").hide(),$("#rg2-results-tab").hide(),$("#rg2-courses-tab").hide(),$("#rg2-events-tab").hide(),Wb.tabs("option","active",$b.TAB_LOGIN),xb=""):xb="Select an event",Yb.addEventListener("touchstart",ac,!1),Yb.addEventListener("touchmove",bc,!1),Yb.addEventListener("touchend",cc,!1),t(Zb),m(),window.addEventListener("resize",m,!1),Yb.addEventListener("DOMMouseScroll",ec,!1),Yb.addEventListener("mousewheel",ec,!1),Yb.addEventListener("mousedown",fc,!1),Yb.addEventListener("mousemove",gc,!1),Yb.addEventListener("mouseup",hc,!1),wb.addEventListener("load",function(){k()},!1),$(document).bind("contextmenu",function(a){a.preventDefault()}),e(),j(),setTimeout(function(){$("#rg2-container").show()},500)}function c(){try{"localStorage"in window&&null!==window.localStorage&&null!==localStorage.getItem("rg2-options")&&(_b=JSON.parse(localStorage.getItem("rg2-options")),_b.circleSize=20,0===_b.mapIntensity&&rg2.showWarningDialog("Warning","Your saved settings have 0% map intensity so the map is invisible. You can adjust this on the configuration menu"))}catch(a){console.log("Local storage not supported")}}function d(a){return vb.hasOwnProperty(a)?vb[a]:a}function e(){var a;$("#rg2-events-tab a").text(d("Events")),$("#rg2-courses-tab a").text(d("Courses")),$("#rg2-results-tab a").text(d("Results")),$("#rg2-draw-tab a").text(d("Draw")),$("#rg2-hide-info-panel-icon").prop("title",d("Hide info panel")),$("#btn-about").prop("title",d("Help")),$("#btn-options").prop("title",d("Options")),$("#btn-zoom-out").prop("title",d("Zoom out")),$("#btn-zoom-in").prop("title",d("Zoom in")),$("#btn-reset").prop("title",d("Reset")),$("#btn-show-splits").prop("title",d("Splits")),a=$("#btn-toggle-controls").prop("title"),$("#btn-toggle-controls").prop("title",d(a)),a=$("#btn-toggle-names").prop("title"),$("#btn-toggle-names").prop("title",d(a)),$("#rg2-splits-table").prop("title",d("Splits table")),$("#btn-slower").prop("title",d("Slower")),$("#btn-faster").prop("title",d("Faster")),a=$("#btn-start-stop").prop("title"),$("#btn-start-stop").prop("title",d(a)),$("#btn-real-time").prop("title",d("Real time")),$("#btn-mass-start").prop("title",d("Mass start")),$("label[for=rg2-control-select]").prop("textContent",d("Start at")),$("label[for=btn-full-tails]").prop("textContent",d("Full tails")),$("label[for=spn-tail-length]").prop("textContent",d("Length")),$(".rg2-options-dialog .ui-dialog-title").text(d("Configuration options")),$("label[for=rg2-select-language]").prop("textContent",d("Language")),$("label[for=spn-map-intensity]").prop("textContent",d("Map intensity %")),$("label[for=spn-route-intensity]").prop("textContent",d("Route intensity %")),$("label[for=spn-route-width]").prop("textContent",d("Route width")),$("label[for=spn-name-font-size]").prop("textContent",d("Replay label font size")),$("label[for=spn-course-width]").prop("textContent",d("Course overprint width")),$("label[for=spn-control-circle]").prop("textContent",d("Control circle size")),$("label[for=chk-snap-toggle]").prop("textContent",d("Snap to control when drawing")),$("label[for=chk-show-three-seconds]").prop("textContent",d("Show +3 time loss for GPS routes")),$("label[for=chk-show-GPS-speed]").prop("textContent",d("Show GPS speed colours")),$("#btn-undo").button("option","label",d("Undo")),$("#btn-undo-gps-adjust").button("option","label",d("Undo")),$("#btn-save-route").button("option","label",d("Save")),$("#btn-reset-drawing").button("option","label",d("Reset")),$("#btn-three-seconds").button("option","label",d("+3 sec")),$("#btn-save-gps-route").button("option","label",d("Save GPS route")),$("#rg2-draw-title").text(d("Draw route")),$("#draw-text-1").text(d("Left click to add/lock/unlock a handle")),$("#draw-text-2").text(d("Green - draggable")),$("#draw-text-3").text(d("Red - locked")),$("#draw-text-4").text(d("Right click to delete a handle")),$("#draw-text-5").text(d("Drag a handle to adjust track around locked point(s)")),$("#rg2-load-gps-title").text(d("Load GPS file (GPX or TCX)")),$("label[for=rg2-course-select]").prop("textContent",d("Select course")),$("label[for=rg2-name-select]").prop("textContent",d("Select name")),$("label[for=btn-move-all]").prop("textContent",d("Move track and map together (or right click-drag)"))}function f(){$("#rg2-select-language").empty();var a,b,c=document.getElementById("rg2-select-language");b=document.createElement("option"),b.value="en",b.text="en: English","en"===vb.code&&(b.selected=!0),c.options.add(b);for(a in rg2Config.languages)b=document.createElement("option"),b.value=a,b.text=a+": "+rg2Config.languages[a],vb.code===a&&(b.selected=!0),c.options.add(b)}function g(a){$.getJSON(rg2Config.json_url,{id:a,type:"lang",cache:!1}).done(function(a){vb=a.data,h()}).fail(function(a,b,c){i("Language request failed: "+c)})}function h(){$("#rg2-event-list").menu("destroy"),x();var a=yb.getActiveEventID();null!==a&&(zb.removeAllFromDisplay(),Ab.removeAllTracksFromDisplay(),Db.resetAnimation(),Fb.initialiseDrawing(yb.hasResults(a)),D(),J()),e(),Wb.tabs("refresh"),o(!1)}function i(a){$("#rg2-load-progress").hide(),$("body").css("cursor","auto"),rg2.showWarningDialog("Configuration error",a)}function j(){$.getJSON(rg2Config.json_url,{type:"events",cache:!1}).done(function(a){if(console.log("Events: "+a.data.length),yb.deleteAllEvents(),$.each(a.data,function(){yb.addEvent(new Event(this))}),x(),Ub){var b=yb.getEventIDForKartatID(Ub);void 0!==b&&y(b)}Vb&&Eb.eventListLoaded()}).fail(function(a,b,c){i("Events request failed: "+c)})}function k(){l(),Vb&&Eb.mapLoadCallback()}function l(){var a,b=Yb.height/wb.height;Ib=Yb.width/2,Jb=Yb.height/2,Kb=1,Lb=null,Mb=!0,a=1>b?b:1,Gb||window.innerWidth>=$b.BIG_SCREEN_BREAK_POINT?Zb.setTransform(a,0,0,a,Wb.outerWidth(),0):Zb.setTransform(a,0,0,a,0,0),Zb.save(),o(!1)}function m(){Hb=$b.DEFAULT_SCALE_FACTOR;var a=window.innerWidth,b=window.innerHeight;$("#rg2-container").css("height",b-36),Yb.width=a,Yb.height=b-36,z(),l()}function n(){var a=Wb.tabs("option","active");switch(a){case $b.TAB_DRAW:zb.removeAllFromDisplay(),Fb.showCourseInProgress()}o(!1)}function o(a){if(Zb.save(),Zb.setTransform(1,0,0,1,0,0),Zb.fillStyle=$b.WHITE,Zb.fillRect(0,0,Zb.canvas.width,Zb.canvas.height),Zb.restore(),Zb.globalAlpha=_b.mapIntensity/100,wb.height>0){Zb.drawImage(wb,0,0);var b=Wb.tabs("option","active");b===$b.TAB_DRAW?(zb.drawCourses($b.DIM),Bb.drawControls(!1),Ab.drawTracks(),Fb.drawNewTrack()):b===$b.TAB_CREATE?Eb.drawControls():(zb.drawCourses($b.FULL_INTENSITY),Ab.drawTracks(),Bb.drawControls(!1),Db.runAnimation(a?!0:!1))}else Zb.font="30pt Arial",Zb.textAlign="center",Zb.fillStyle=$b.BLACK,Zb.fillText(d(xb),Yb.width/2,Yb.height/2)}function p(){$("#rg2-event-stats").empty().html(w()),$("#rg2-about-dialog").dialog({width:Math.min(1e3,.8*Yb.width),maxHeight:Math.min(1e3,.9*Yb.height),title:"RG2 Version "+$b.RG2VERSION,resizable:!1,buttons:{Ok:function(){$(this).dialog("close")}}})}function q(){$("#rg2-option-controls").dialog({minWidth:400,title:d("Configuration options"),dialogClass:"rg2-options-dialog",close:function(){r()}})}function r(){try{"localStorage"in window&&null!==window.localStorage&&(_b.snap=$("#chk-snap-toggle").prop("checked"),_b.showThreeSeconds=$("#chk-show-three-seconds").prop("checked"),_b.showGPSSpeed=$("#chk-show-GPS-speed").prop("checked"),localStorage.setItem("rg2-options",JSON.stringify(_b)))}catch(a){return}}function s(){Gb?(Gb=!1,$("#rg2-resize-info").prop("title",d("Show info panel")),$("#rg2-hide-info-panel-control").css("left","0px"),$("#rg2-hide-info-panel-icon").removeClass("fa-chevron-left").addClass("fa-chevron-right").prop("title",d("Show info panel")),Wb.hide()):(Gb=!0,$("#rg2-resize-info").prop("title",d("Hide info panel")),$("#rg2-hide-info-panel-control").css("left","366px"),$("#rg2-hide-info-panel-icon").removeClass("fa-chevron-right").addClass("fa-chevron-left").prop("title",d("Hide info panel")),Wb.show()),l()}function t(a){var b=document.createElementNS("http://www.w3.org/2000/svg","svg"),c=b.createSVGMatrix();a.getTransform=function(){return c};var d=[],e=a.save;a.save=function(){return d.push(c.translate(0,0)),e.call(a)};var f=a.restore;a.restore=function(){return c=d.pop(),f.call(a)};var g=a.scale;a.scale=function(b,d){return c=c.scaleNonUniform(b,d),g.call(a,b,d)};var h=a.rotate;a.rotate=function(b){return c=c.rotate(180*b/Math.PI),h.call(a,b)};var i=a.translate;a.translate=function(b,d){return c=c.translate(b,d),i.call(a,b,d)};var j=a.transform;a.transform=function(d,e,f,g,h,i){var k=b.createSVGMatrix();return k.a=d,k.b=e,k.c=f,k.d=g,k.e=h,k.f=i,c=c.multiply(k),j.call(a,d,e,f,g,h,i)};var k=a.setTransform;a.setTransform=function(b,d,e,f,g,h){return c.a=b,c.b=d,c.c=e,c.d=f,c.e=g,c.f=h,k.call(a,b,d,e,f,g,h)};var l=b.createSVGPoint();a.transformedPoint=function(a,b){return l.x=a,l.y=b,l.matrixTransform(c.inverse())}}function u(a,b){var c="<div>"+b+"</div>";$(c).dialog({title:a})}function v(a,b,c,d){return Math.sqrt(Math.pow(a-c,2)+Math.pow(b-d,2))}function w(){var a,b,c;return null===yb.getActiveEventID()?"":(b=zb.getCoursesForEvent(),c=Ab.getResultsInfo(),a="<h3>"+d("Event statistics")+"</h3>",a+="<p><strong>"+d("Courses")+":</strong> "+b.length+" <strong>"+d("Results")+":</strong> "+c.results,a+="<strong> "+d("Drawn routes")+":</strong> "+c.drawnroutes+" <strong>"+d("GPS routes"),a+=":</strong> "+c.gpsroutes+" ("+c.percent+"%)</p>",a+="<p><strong>"+d("Total time")+":</strong> "+c.time+"</p>",a+="<p><strong>"+d("Map ")+":</strong> ID "+yb.getActiveMapID()+", "+wb.width+" x "+wb.height+" pixels </p>",a+="<p><strong>"+d("Comments")+":</strong></p>",a+=Ab.getComments(),a=a.replace(/&amp;/g,"&"))}function x(){var a=yb.formatEventsAsMenu();$("#rg2-event-list").append(a).menu({select:function(a,b){y(b.item[0].id)}})}function y(a){$("#rg2-event-list > li").removeClass("rg2-active-event").filter("#"+a).addClass("rg2-active-event"),$("body").css("cursor","wait"),$("#rg2-load-progress-label").text(d("Loading courses")),$("#rg2-load-progress").show(),zb.deleteAllCourses(),Bb.deleteAllControls(),Db.resetAnimation(),Ab.deleteAllResults(),yb.setActiveEventID(a),Fb.initialiseDrawing(yb.hasResults(a)),A(rg2Config.maps_url+yb.getMapFileName()),o(!1),z(),$.getJSON(rg2Config.json_url,{id:yb.getKartatEventID(),type:"courses",cache:!1}).done(function(a){$("#rg2-load-progress-label").text(d("Saving courses")),console.log("Courses: "+a.data.length),$.each(a.data,function(){zb.addCourse(new Course(this,yb.isScoreEvent()))}),zb.updateCourseDropdown(),zb.generateControlList(Bb),$("#btn-toggle-controls").show(),$("#btn-toggle-names").show(),B()}).fail(function(a,b,c){i("Courses request failed for event "+yb.getKartatEventID()+": "+c)})}function z(){var a;window.innerWidth>=$b.BIG_SCREEN_BREAK_POINT?(a=yb.getActiveEventName()+" "+yb.getActiveEventDate(),Xb.html(a).show()):window.innerWidth>$b.SMALL_SCREEN_BREAK_POINT?(a=yb.getActiveEventName(),Xb.html(a).show()):Xb.hide(),yb.mapIsGeoreferenced()?$("#rg2-event-title-icon").addClass("fa fa-globe"):$("#rg2-event-title-icon").removeClass("fa fa-globe")}function A(a){xb="Loading map",wb.src=a}function B(){$("#rg2-load-progress-label").text(d("Loading results")),$.getJSON(rg2Config.json_url,{id:yb.getKartatEventID(),type:"results",cache:!1}).done(function(a){console.log("Results: "+a.data.length),$("#rg2-load-progress-label").text(d("Saving results"));var b=yb.isScoreEvent();zb.getNumberOfCourses()>0&&Ab.addResults(a.data,b),zb.setResultsCount(),b&&(Bb.deleteAllControls(),Ab.generateScoreCourses(),zb.generateControlList(Bb)),$("#rg2-result-list").accordion("refresh"),C()}).fail(function(a,b,c){i("Results request failed for event "+yb.getKartatEventID()+": "+c)})}function C(){$("#rg2-load-progress-label").text(d("Loading routes")),$.getJSON(rg2Config.json_url,{id:yb.getKartatEventID(),type:"tracks",cache:!1}).done(function(a){if($("#rg2-load-progress-label").text(d("Saving routes")),console.log("Tracks: "+a.data.length),zb.getNumberOfCourses()>0&&Ab.addTracks(a.data),D(),J(),Db.updateAnimationDetails(),$("body").css("cursor","auto"),Vb)Eb.eventFinishedLoading();else{Wb.tabs("enable",$b.TAB_COURSES),Wb.tabs("enable",$b.TAB_RESULTS),Wb.tabs("enable",$b.TAB_DRAW);var b=Wb.tabs("option","active");b!==$b.TAB_DRAW&&Wb.tabs("option","active",$b.TAB_COURSES),Wb.tabs("refresh"),$("#btn-show-splits").show(),rg2Config.enable_splitsbrowser&&yb.hasResults()?$("#rg2-splitsbrowser").off().click(function(){window.open(rg2Config.json_url+"?type=splitsbrowser&id="+yb.getKartatEventID())}).show():$("#rg2-splitsbrowser").off().hide()}$("#rg2-load-progress-label").text(""),$("#rg2-load-progress").hide(),o(!1)}).fail(function(a,b,c){i("Routes request failed for event "+yb.getKartatEventID()+": "+c)})}function D(){$("#rg2-course-table").empty().append(zb.formatCoursesAsTable()),$(".courselist").click(function(a){a.target.checked?zb.putOnDisplay(parseInt(a.currentTarget.id,10)):(zb.removeFromDisplay(parseInt(a.currentTarget.id,10)),$(".allcourses").prop("checked",!1)),o(!1)}),$(".allcourses").click(function(a){a.target.checked?(zb.putAllOnDisplay(),$(".courselist").prop("checked",!0)):(zb.removeAllFromDisplay(),$(".courselist").prop("checked",!1)),o(!1)}),$(".tracklist").click(function(a){var b=a.target.id;a.target.checked?Ab.putTracksOnDisplay(b):(Ab.removeTracksFromDisplay(b),$(".alltracks").prop("checked",!1)),o(!1)}),$(".alltracks").click(function(a){a.target.checked?(Ab.putAllTracksOnDisplay(),$(".tracklist").prop("checked",!0)):(Ab.removeAllTracksFromDisplay(),$(".tracklist").prop("checked",!1)),o(!1)})}function E(a,b,c,d){var e=Math.atan2(d-b,c-a);return 0>e&&(e+=2*Math.PI),e}function F(a,b,c,d){var e=c-a,f=e.toRad(),g=d-b,h=g.toRad(),i=Math.sin(f/2)*Math.sin(f/2)+Math.cos(a.toRad())*Math.cos(c.toRad())*Math.sin(h/2)*Math.sin(h/2),j=2*Math.atan2(Math.sqrt(i),Math.sqrt(1-i));return 6371009*j}function G(a){if(!a)return 0;var b=0,c=a.split(":");return 2===c.length?b=60*parseInt(c[0],10)+parseInt(c[1],10):3===c.length&&(b=3600*parseInt(c[0],10)+60*parseInt(c[1],10)+parseInt(c[2],10)),isNaN(b)?0:b}function H(a){if(!a)return 0;var b=0,c=a.split(":");return b=3600*parseInt(c[0],10)+60*parseInt(c[1],10)+parseInt(c[2],10),isNaN(b)?0:b}function I(a){var b,c=Math.floor(a/60);b=c;var d=a-60*c;return b+=10>d?":0"+d:":"+d}function J(){var a=Ab.formatResultListAsAccordion();a=a.replace(/&amp;/g,"&"),$("#rg2-result-list").empty().append(a),$("#rg2-result-list").accordion("refresh"),Wb.tabs("refresh"),$(".showcourse").click(function(a){a.stopPropagation(),a.target.checked?zb.putOnDisplay(a.target.id):zb.removeFromDisplay(a.target.id),o(!1)}),$(".showscorecourse").click(function(a){Ab.displayScoreCourse(parseInt(a.target.id,10),a.target.checked),o(!1)}),$(".showtrack").click(function(a){a.target.checked?Ab.putOneTrackOnDisplay(a.target.id):Ab.removeOneTrackFromDisplay(a.target.id),o(!1)}),$(".showreplay").click(function(a){a.target.checked?Db.addRunner(new Runner(parseInt(a.target.id,10)),!0):Db.removeRunner(parseInt(a.target.id,10),!0),o(!1)}),$(".allcoursetracks").click(function(a){var b,c;b=Ab.getAllRunnersForCourse(parseInt(a.target.id,10));var d;for(d=0;d<b.length;d+=1)a.target.checked?Ab.putOneTrackOnDisplay(b[d]):Ab.removeOneTrackFromDisplay(b[d]);c=".showtrack-"+a.target.id,a.target.checked?$(c).prop("checked",!0):$(c).prop("checked",!1),o(!1)}),$(".allcoursereplay").click(function(a){var b,c;b=Ab.getAllRunnersForCourse(parseInt(a.target.id,10)),Db.animateRunners(b,a.target.checked),c=".showreplay-"+a.target.id,a.target.checked?$(c).prop("checked",!0):$(c).prop("checked",!1),o(!1)}),0===zb.getHighestControlNumber()?$("#rg2-control-select").prop("disabled",!0):$("#rg2-control-select").prop("disabled",!1)}function K(a){return zb.getFullCourse(a)}function L(a){return zb.getCourseName(a)}function M(a){return Ab.countResultsByCourseID(a)}function N(a,b,c,d,e){return Bb.drawStart(a,b,c,d,e)}function O(a,b,c,d){return Bb.drawSingleControl(a,b,c,d)}function P(a,b,c,d){return Bb.drawFinish(a,b,c,d)}function Q(a){return Ab.getFullResult(a)}function R(){return zb.getHighestControlNumber()}function S(a){return yb.getKartatEventID(a)}function T(){return yb.hasResults()}function U(a){return zb.incrementTracksCount(a)}function V(a){zb.putOnDisplay(a)}function W(a,b){Ab.putScoreCourseOnDisplay(a,b)}function X(a){zb.removeFromDisplay(a)}function Y(a){Ab.createNameDropdown(a)}function Z(a){return Ab.getRunnerName(a)}function _(a){return Ab.resultIDExists(a)}function ab(a){return Ab.getTimeForID(a)}function bb(a){return Ab.getSplitsForID(a)}function cb(){return yb.mapIsGeoreferenced()}function db(){var a={};return a.height=wb.height,a.width=wb.width,a}function eb(){return yb.getWorldFile()}function fb(){return Fb.getControlX()}function gb(){return Fb.getControlY()}function hb(){return yb.getActiveEventID()}function ib(){yb.createEventEditDropdown()}function jb(){return _b.routeWidth}function kb(){var a={},b=db(),c=Math.pow(Math.min(b.height,b.width)/1500,.5);c=Math.min(c,5),c=Math.max(c,.5);var d=Math.round(_b.circleSize*c);return a.controlRadius=d,a.finishInnerRadius=d*(5/6),a.finishOuterRadius=d*(7/6),a.startTriangleLength=d*(7/6),a.overprintWidth=_b.courseWidth,a.font=d+"pt Arial",a}function lb(){return _b.routeIntensity/100}function mb(){return _b.replayFontSize}function nb(){return $("#chk-show-three-seconds").prop("checked")}function ob(){return $("#chk-show-GPS-speed").prop("checked")}function pb(a){return yb.getEventInfo(a)}function qb(){return zb.getCoursesForEvent()}function rb(){return Ab.getRoutesForEvent()}function sb(){return Cb.getNextColour()}function tb(a,b,c,d){zb.updateScoreCourse(a,b,c,d)}function ub(){return _b.snap}var vb,wb,xb,yb,zb,Ab,Bb,Cb,Db,Eb,Fb,Gb,Hb,Ib,Jb,Kb,Lb,Mb,Nb,Ob,Pb,Qb,Rb,Sb,Tb,Ub,Vb,Wb,Xb,Yb=$("#rg2-map-canvas")[0],Zb=Yb.getContext("2d"),$b={DEFAULT_SCALE_FACTOR:1.1,TAB_EVENTS:0,TAB_COURSES:1,TAB_RESULTS:2,TAB_DRAW:3,TAB_LOGIN:4,TAB_CREATE:5,TAB_EDIT:6,TAB_MAP:7,DEFAULT_NEW_COMMENT:"Type your comment",DEFAULT_EVENT_COMMENT:"Comments (optional)",GPS_RESULT_OFFSET:5e4,MASS_START_REPLAY:1,REAL_TIME_REPLAY:2,MASS_START_BY_CONTROL:99999,VERY_HIGH_TIME_IN_SECS:99999,BIG_SCREEN_BREAK_POINT:800,SMALL_SCREEN_BREAK_POINT:500,PURPLE:"#b300ff",RED:"#ff0000",GREEN:"#00ff00",WHITE:"#ffffff",BLACK:"#ffoooo",RUNNER_DOT_RADIUS:6,DIM:.75,FULL_INTENSITY:1,NORMAL_EVENT:1,EVENT_WITHOUT_RESULTS:2,SCORE_EVENT:3,RG2VERSION:"0.9.3",TIME_NOT_FOUND:9999,SPLITS_NOT_FOUND:9999,RIGHT_CLICK:3},_b={mapIntensity:100,routeIntensity:100,replayFontSize:12,courseWidth:3,routeWidth:4,circleSize:20,snap:!0,showThreeSeconds:!1,showGPSSpeed:!1};Number.prototype.toRad=function(){return this*Math.PI/180},a.prototype={Constructor:a,getNextColour:function(){return this.colourIndex+=1,this.colourIndex===this.colours.length&&(this.colourIndex=0),this.colours[this.colourIndex]}};var ac=function(a){a.preventDefault(),a.touches.length>1&&(Pb=Zb.transformedPoint(a.touches[0].pageX,a.touches[0].pageY),Qb=Zb.transformedPoint(a.touches[1].pageX,a.touches[1].pageY),Ob=!0),Ib=a.touches[0].pageX,Jb=a.touches[0].pageY,ic(a)},bc=function(a){var b,c;a.touches.length>1?Ob||(Pb=Zb.transformedPoint(a.touches[0].pageX,a.touches[0].pageY),Qb=Zb.transformedPoint(a.touches[1].pageX,a.touches[1].pageY),Ob=!0):Ob=!1,Ob&&a.touches.length>1?(Rb=Zb.transformedPoint(a.touches[0].pageX,a.touches[0].pageY),Sb=Zb.transformedPoint(a.touches[1].pageX,a.touches[1].pageY),b=v(Pb.x,Pb.y,Qb.x,Qb.y),c=v(Rb.x,Rb.y,Sb.x,Sb.y),b/c>1.1?(dc(-1),Pb=Rb,Qb=Sb):.9>b/c&&(dc(1),Pb=Rb,Qb=Sb)):(Ib=a.touches[0].pageX,Jb=a.touches[0].pageY,jc(a))},cc=function(a){kc(a),Ob=!1},dc=function(a){var b=Math.pow(Hb,a),c=Kb*b;if(50>c&&c>.05){Kb=c;var d=Zb.transformedPoint(Ib,Jb);Zb.translate(d.x,d.y),Zb.scale(b,b),Zb.translate(-d.x,-d.y),Zb.save(),o(!1)}},ec=function(a){var b=a.wheelDelta?a.wheelDelta/40:a.detail?-a.detail:0;return b&&dc(b),a.stopPropagation(),a.preventDefault()&&!1},fc=function(a){return Ib=a.offsetX||a.layerX-Yb.offsetLeft,Jb=a.offsetY||a.layerY-Yb.offsetTop,ic(a),a.stopPropagation(),a.preventDefault()&&!1},gc=function(a){return Ib=a.offsetX||a.layerX-Yb.offsetLeft,Jb=a.offsetY||a.layerY-Yb.offsetTop,jc(a),a.stopPropagation(),a.preventDefault()&&!1},hc=function(a){return kc(a),a.stopPropagation(),a.preventDefault()&&!1},ic=function(a){Lb=Zb.transformedPoint(Ib,Jb),Mb=!1,Nb=a.which},jc=function(a){if(Lb){var b=Zb.transformedPoint(Ib,Jb);Math.abs(b.x-Lb.x)+Math.abs(b.y-Lb.y)>5&&(Fb.gpsFileLoaded()?Fb.adjustTrack(Math.round(Lb.x),Math.round(Lb.y),Math.round(b.x),Math.round(b.y),Nb,a.shiftKey,a.ctrlKey):Wb.tabs("option","active")===$b.TAB_CREATE?Eb.adjustControls(Math.round(Lb.x),Math.round(Lb.y),Math.round(b.x),Math.round(b.y),Nb,a.shiftKey,a.ctrlKey):Zb.translate(b.x-Lb.x,b.y-Lb.y),Mb=!0,o(!1))}},kc=function(a){var b=Wb.tabs("option","active");Mb?b===$b.TAB_CREATE?Eb.dragEnded():Fb.dragEnded():b===$b.TAB_CREATE?Eb.mouseUp(Math.round(Lb.x),Math.round(Lb.y)):Fb.mouseUp(Math.round(Lb.x),Math.round(Lb.y),a.which),Lb=null,o(!1)};return{t:d,init:b,config:$b,options:_b,redraw:o,getOverprintDetails:kb,getRouteWidth:jb,getRouteIntensity:lb,getReplayFontSize:mb,ctx:Zb,getMapSize:db,loadNewMap:A,loadEvent:y,loadEventList:j,eventHasResults:T,mapIsGeoreferenced:cb,getWorldFile:eb,getFullResult:Q,drawStart:N,drawSingleControl:O,drawFinish:P,getTimeForID:ab,getSplitsForID:bb,resultIDExists:_,getRunnerName:Z,putOnDisplay:V,putScoreCourseOnDisplay:W,removeFromDisplay:X,createNameDropdown:Y,incrementTracksCount:U,getKartatEventID:S,getActiveEventID:hb,getHighestControlNumber:R,getCourseDetails:K,getCourseName:L,countResultsByCourseID:M,getControlX:fb,getControlY:gb,createEventEditDropdown:ib,showThreeSeconds:nb,showGPSSpeed:ob,getEventInfo:pb,getCoursesForEvent:qb,getRoutesForEvent:rb,getNextRouteColour:sb,updateScoreCourse:tb,getSnapToControl:ub,getAngle:E,showWarningDialog:u,getDistanceBetweenPoints:v,getSecsFromMMSS:G,getSecsFromHHMMSS:H,formatSecsAsMMSS:I,getLatLonDistance:F}
