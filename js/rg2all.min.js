...
function Animation(){"use strict";this.runners=[],this.timer=null,this.animationSecs=0,this.deltaSecs=5,this.timerInterval=100,this.realTime=!1,this.earliestStartSecs=0,this.latestFinishSecs=0,this.tailLength=0,this.useFullTails=!1,this.massStartControl=0,this.massStartByControl=!1,this.displayNames=!0,this.displayInitials=!1}function Controls(){this.controls=[],this.displayControls=!1}function Control(a,b,c){this.code=a,this.x=b,this.y=c}function Courses(){this.courses=[],this.totaltracks=0,this.numberofcourses=0,this.highestControlNumber=0}function Course(a,b){this.name=a.name,this.trackcount=0,this.display=!1,this.courseid=a.courseid,this.codes=a.codes,this.x=a.xpos,this.y=a.ypos,this.isScoreCourse=b,this.resultcount=0}function Draw(){this.trackColor="#ff0000",this.HANDLE_DOT_RADIUS=7,this.hasResults=!1,this.initialiseDrawing()}function RouteData(){this.courseid=null,this.coursename=null,this.resultid=null,this.isScoreCourse=!1,this.eventid=null,this.name=null,this.comments=null,this.x=[],this.y=[],this.controlx=[],this.controly=[],this.time=[],this.startsecs=0,this.totaltime=0}function Events(){this.events=[],this.activeEventID=null}function Event(a){switch(this.kartatid=parseInt(a.id,10),this.mapid=a.mapid,this.format=parseInt(a.format,10),this.name=a.name,this.date=a.date,this.club=a.club,this.worldFile=[],"undefined"==typeof a.A?this.georeferenced=!1:(this.georeferenced=!0,this.worldFile.A=a.A,this.worldFile.B=a.B,this.worldFile.C=a.C,this.worldFile.D=a.D,this.worldFile.E=a.E,this.worldFile.F=a.F),this.rawtype=a.type,a.type){case"I":this.type="International event";break;case"N":this.type="National event";break;case"R":this.type="Regional event";break;case"L":this.type="Local event";break;case"T":this.type="Training event";break;default:this.type="Unknown"}this.comment=a.comment,this.courses=0}function GPSTrack(){this.lat=[],this.lon=[],this.time=[],this.baseX=[],this.baseY=[],this.handles=[],this.savedBaseX=[],this.savedBaseY=[],this.savedHandles=[],this.fileLoaded=!1,this.fileName="",this.routeData=new RouteData}function Colours(){this.colours=["#ff0000","#ff8000","#ff00ff","#ff0080","#008080","#008000","#00ff00","#0080ff","#0000ff","#8000ff","#00ffff","#808080"],this.colourIndex=0}function rg2WarningDialog(a,b){var c="<div>"+b+"</div>";$(c).dialog({title:a})}function getLatLonDistance(a,b,c,d){var e=c-a,f=e.toRad(),g=d-b,h=g.toRad(),i=Math.sin(f/2)*Math.sin(f/2)+Math.cos(a.toRad())*Math.cos(c.toRad())*Math.sin(h/2)*Math.sin(h/2),j=2*Math.atan2(Math.sqrt(i),Math.sqrt(1-i));return 6371009*j}function getAngle(a,b,c,d){var e=Math.atan2(d-b,c-a);return 0>e&&(e+=2*Math.PI),e}function getDistanceBetweenPoints(a,b,c,d){return Math.sqrt(Math.pow(a-c,2)+Math.pow(b-d,2))}function formatSecsAsMMSS(a){var b,c=Math.floor(a/60);b=c;var d=a-60*c;return b+=10>d?":0"+d:":"+d}function getSecsFromHHMMSS(a){var b=0,c=a.split(":");return b=3600*parseInt(c[0],10)+60*parseInt(c[1],10)+parseInt(c[2],10),isNaN(b)?0:b}function getSecsFromMMSS(a){var b=0,c=a.split(":");return b=60*parseInt(c[0],10)+parseInt(c[1],10),isNaN(b)?0:b}function trackTransforms(a){var b=document.createElementNS("http://www.w3.org/2000/svg","svg"),c=b.createSVGMatrix();a.getTransform=function(){return c};var d=[],e=a.save;a.save=function(){return d.push(c.translate(0,0)),e.call(a)};var f=a.restore;a.restore=function(){return c=d.pop(),f.call(a)};var g=a.scale;a.scale=function(b,d){return c=c.scaleNonUniform(b,d),g.call(a,b,d)};var h=a.rotate;a.rotate=function(b){return c=c.rotate(180*b/Math.PI),h.call(a,b)};var i=a.translate;a.translate=function(b,d){return c=c.translate(b,d),i.call(a,b,d)};var j=a.transform;a.transform=function(d,e,f,g,h,i){var k=b.createSVGMatrix();return k.a=d,k.b=e,k.c=f,k.d=g,k.e=h,k.f=i,c=c.multiply(k),j.call(a,d,e,f,g,h,i)};var k=a.setTransform;a.setTransform=function(b,d,e,f,g,h){return c.a=b,c.b=d,c.c=e,c.d=f,c.e=g,c.f=h,k.call(a,b,d,e,f,g,h)};var l=b.createSVGPoint();a.transformedPoint=function(a,b){return l.x=a,l.y=b,l.matrixTransform(c.inverse())}}function Results(){this.results=[]}function Result(a,b,c,d,e){this.resultid=a.resultid,this.isScoreEvent=b,this.isGPSTrack=this.resultid>=rg2.config.GPS_RESULT_OFFSET?!0:!1,this.name=a.name,this.initials=this.getInitials(this.name),this.starttime=a.starttime,this.time=a.time,this.comments=null!==a.comments?a.comments.replace("'","&apos;"):"",this.coursename=a.coursename,""===this.coursename&&(this.coursename=a.courseid),this.courseid=a.courseid,this.splits=a.splits,this.splits.splice(0,0,0),""!==a.scoreref&&(this.scorex=d,this.scorey=e,this.scorecodes=c),this.cumulativeDistance=[],this.hasValidTrack=!1,this.displayTrack=!1,this.displayScoreCourse=!1,this.trackColour=null,this.trackx=[],this.tracky=[],this.speedColour=[],this.xysecs=[],this.isGPSTrack&&(this.time=rg2.getTimeForID(this.resultid-rg2.config.GPS_RESULT_OFFSET),this.time===rg2.config.TIME_NOT_FOUND&&(this.time=a.time),this.splits=rg2.getSplitsForID(this.resultid-rg2.config.GPS_RESULT_OFFSET)),this.legpos=[],a.gpsx.length>0&&this.addTrack(a)}function Runner(a){var b,c;b=rg2.getFullResult(a),this.name=b.name,this.initials=b.initials,this.runnerid=a,this.starttime=b.starttime,this.splits=b.splits,this.legpos=b.legpos,this.colour=null===b.trackColour?rg2.getNextRouteColour():b.trackColour,b.isScoreEvent?(c={},c.name=b.coursename,c.x=b.scorex,c.y=b.scorey,c.codes=b.scorecodes):c=rg2.getCourseDetails(b.courseid),this.coursename=c.name,this.nextStopTime=rg2.config.VERY_HIGH_TIME_IN_SECS,this.x=[],this.y=[],this.legTrackDistance=[],this.cumulativeTrackDistance=[];var d=[];this.x[0]=c.x[0],this.y[0]=c.y[0];var e,f,g,h,i,j,k,l,m,n,o,p,q,r=0,s=0,t=0,u=0,v=c.x[0],w=c.y[0];if(b.hasValidTrack)for(this.x[0]=b.trackx[0],this.y[0]=b.tracky[0],d[0]=0,v=b.trackx[0],w=b.tracky[0],g=0,o=0,n=1;n<b.xysecs.length;n+=1){for(e=b.trackx[n],f=b.tracky[n],h=e-v,i=f-w,o+=Math.sqrt((e-v)*(e-v)+(f-w)*(f-w)),k=o-g,t=b.xysecs[n],j=t-u,m=u+1;t>m;m+=1)this.x[m]=Math.round(v+(m-u)*h/j),this.y[m]=Math.round(w+(m-u)*i/j),d[m]=Math.round(g+(m-u)*k/j);this.x[t]=e,this.y[t]=f,d[t]=o,v=e,w=f,g=o,u=t}else for(this.x[0]=c.x[0],this.y[0]=c.y[0],d[0]=0,v=c.x[0],w=c.y[0],g=0,o=0,l=1;l<c.codes.length;l+=1){for(e=c.x[l],f=c.y[l],h=e-v,i=f-w,o+=Math.sqrt((e-v)*(e-v)+(f-w)*(f-w)),k=o-g,s=b.splits[l],j=s-r,m=r+1;s>m;m+=1)this.x[m]=Math.round(v+(m-r)*h/j),this.y[m]=Math.round(w+(m-r)*i/j),d[m]=Math.round(g+(m-u)*k/j);this.x[s]=e,this.y[s]=f,d[s]=o,v=e,w=f,g=o,r=s}if(this.legTrackDistance[0]=0,this.cumulativeTrackDistance[0]=0,p=d.length-1,"undefined"!=typeof c.codes)if(b.splits!==rg2.config.SPLITS_NOT_FOUND)for(l=1;l<c.codes.length;l+=1)q=b.splits[l]<=p?b.splits[l]:p,this.cumulativeTrackDistance[l]=Math.round(d[q]),this.legTrackDistance[l]=this.cumulativeTrackDistance[l]-this.cumulativeTrackDistance[l-1];else this.legTrackDistance[1]=Math.round(d[p]),this.cumulativeTrackDistance[1]=Math.round(d[p]);b=0,c=0}var rg2=function(){"use strict";function a(){$("#rg2-container").hide(),"undefined"==typeof rg2Config.dictionary?(lb={},lb.code="en"):lb=rg2Config.dictionary,e(),Mb=$("#rg2-info-panel"),Nb=$("#rg2-event-title"),$.ajaxSetup({cache:!1}),Lb=0!==$("#rg2-manage-login").length?!0:!1,Jb=window.location.hash,Jb&&!Lb&&(Kb=parseInt(Jb.replace("#",""),10)),$("#btn-save-route").button().button("disable"),$("#btn-save-gps-route").button().button("disable"),$("#btn-reset-drawing").button().button("disable"),$("#btn-undo").button().button("disable"),$("#btn-undo-gps-adjust").button().button("disable"),$("#rg2-load-gps-file").button().button("disable"),$("#btn-three-seconds").button().button("disable"),Mb.tabs({disabled:[Qb.TAB_COURSES,Qb.TAB_RESULTS,Qb.TAB_DRAW],active:Qb.TAB_EVENTS,heightStyle:"content",activate:function(){l()}}),$("#rg2-result-list").accordion({collapsible:!0,heightStyle:"content",select:function(a,b){console.log("Result index selected: "+b.item[0].id)}}),$("#rg2-clock").text("00:00:00"),$("#rg2-clock-slider").slider({slide:function(a,b){tb.clockSliderMoved(b.value)}}),$("#btn-mass-start").addClass("active"),$("#btn-real-time").removeClass("active"),mb=new Image,ob=new Events,pb=new Courses,sb=new Colours,qb=new Results,rb=new Controls,tb=new Animation,vb=new Draw,Bb=null,Cb=!0,wb=!0,$("#rg2-header-container").css("color",rg2Config.header_text_colour),$("#rg2-header-container").css("background",rg2Config.header_colour),$("#rg2-about-dialog").hide(),$("#rg2-splits-display").hide(),$("#rg2-track-names").hide(),$("#rg2-add-new-event").hide(),$("#rg2-load-progress-bar").progressbar({value:!1}),$("#rg2-load-progress-label").text(""),$("#rg2-load-progress").hide(),$("#btn-about").click(function(){n()}),$("#rg2-resize-info").click(function(){q()}),$("#rg2-hide-info-panel-control").click(function(){q()}),$("#btn-mass-start").click(function(){tb.setReplayType(Qb.MASS_START_REPLAY)}),$("#btn-real-time").click(function(){tb.setReplayType(Qb.REAL_TIME_REPLAY)}),$("#rg2-control-select").prop("disabled",!0).click(function(){tb.setStartControl($("#rg2-control-select").val())}),$("#rg2-name-select").prop("disabled",!0).click(function(){vb.setName(parseInt($("#rg2-name-select").val(),10))}),$("#rg2-course-select").click(function(){vb.setCourse(parseInt($("#rg2-course-select").val(),10))}),$("#rg2-enter-name").click(function(){vb.setNameAndTime()}).keyup(function(){vb.setNameAndTime()}),$("#rg2-new-comments").focus(function(){var a=$("#rg2-new-comments").val();a===c(Qb.DEFAULT_NEW_COMMENT)&&$("#rg2-new-comments").val("")}),b(),$("#rg2-option-controls").hide(),$("#spn-map-intensity").spinner({max:100,min:0,step:10,numberFormat:"n",spin:function(a,b){Rb.mapIntensity=b.value,m(!1)}}).val(Rb.mapIntensity),$("#spn-route-intensity").spinner({max:100,min:0,step:10,numberFormat:"n",spin:function(a,b){Rb.routeIntensity=b.value,m(!1)}}).val(Rb.routeIntensity),$("#spn-name-font-size").spinner({max:30,min:5,step:1,numberFormat:"n",spin:function(a,b){Rb.replayFontSize=b.value,m(!1)}}).val(Rb.replayFontSize),$("#spn-course-width").spinner({max:10,min:1,step:.5,spin:function(a,b){Rb.courseWidth=b.value,m(!1)}}).val(Rb.courseWidth),$("#spn-route-width").spinner({max:10,min:1,step:.5,spin:function(a,b){Rb.routeWidth=b.value,m(!1)}}).val(Rb.routeWidth),$("#spn-control-circle").spinner({max:30,min:5,step:1,spin:function(a,b){Rb.circleSize=b.value,m(!1)}}).val(Rb.circleSize),$("#chk-snap-toggle").prop("checked",Rb.snap).click(function(a){Rb.snap=a.target.checked?!0:!1}),$("#chk-show-three-seconds").prop("checked",Rb.showGPSSpeed).click(function(){m(!1)}),$("#chk-show-GPS-speed").prop("checked",Rb.showGPSSpeed).click(function(){m(!1)}),$("#btn-options").click(function(){o()}),$("#rg2-select-language").click(function(){var a;a=$("#rg2-select-language").val(),a!==lb.code&&("en"===a?(lb={},lb.code="en",g()):f(a))}),$("#rg2-animation-controls").hide(),$("#btn-save-route").button().click(function(){vb.saveRoute()}),$("#btn-save-gps-route").button().click(function(){vb.saveGPSRoute()}),$("#btn-move-all").prop("checked",!1),$("#btn-undo").click(function(){vb.undoLastPoint()}),$("#btn-undo-gps-adjust").click(function(){vb.undoGPSAdjust()}),$("#btn-reset-drawing").click(function(){vb.resetDrawing()}),$("#btn-three-seconds").click(function(){vb.waitThreeSeconds()}),$("#rg2-load-gps-file").change(function(a){vb.uploadGPS(a)}),$("#btn-zoom-in").click(function(){Vb(1)}),$("#btn-reset").click(function(){j()}),$("#btn-zoom-out").click(function(){Vb(-1)}),$("#btn-start-stop").click(function(){tb.toggleAnimation()}),$("#btn-faster").click(function(){tb.goFaster()}),$("#btn-slower").click(function(){tb.goSlower()}),$("#btn-toggle-names").click(function(){tb.toggleNameDisplay(),m(!1)}).hide(),$("#rg2-splitsbrowser").hide(),$("#btn-show-splits").click(function(){$("#rg2-splits-table").empty().append(tb.getSplitsTable()).dialog({width:"auto",buttons:{Ok:function(){$(this).dialog("close")}}})}),$("#btn-show-splits").hide(),$("#btn-toggle-controls").click(function(){rb.toggleControlDisplay(),m(!1)}).hide(),$("#spn-tail-length").spinner({max:600,min:0,spin:function(a,b){tb.setTailLength(b.value)}}).val(0),$("#btn-full-tails").prop("checked",!1).click(function(a){a.target.checked?(tb.setFullTails(!0),$("#spn-tail-length").spinner("disable")):(tb.setFullTails(!1),$("#spn-tail-length").spinner("enable"))}),Lb?(ub=new Manager(rg2Config.keksi),$("#rg2-animation-controls").hide(),$("#rg2-create-tab").hide(),$("#rg2-edit-tab").hide(),$("#rg2-map-tab").hide(),$("#rg2-manage-login").show(),Mb.tabs("disable",Qb.TAB_EVENTS),$("#rg2-draw-tab").hide(),$("#rg2-results-tab").hide(),$("#rg2-courses-tab").hide(),$("#rg2-events-tab").hide(),Mb.tabs("option","active",Qb.TAB_LOGIN),nb=""):nb="Select an event",Ob.addEventListener("touchstart",Sb,!1),Ob.addEventListener("touchmove",Tb,!1),Ob.addEventListener("touchend",Ub,!1),trackTransforms(Pb),k(),window.addEventListener("resize",k,!1),Ob.addEventListener("DOMMouseScroll",Wb,!1),Ob.addEventListener("mousewheel",Wb,!1),Ob.addEventListener("mousedown",Xb,!1),Ob.addEventListener("mousemove",Yb,!1),Ob.addEventListener("mouseup",Zb,!1),mb.addEventListener("load",function(){i()},!1),$(document).bind("contextmenu",function(a){a.preventDefault()}),d(),h(),setTimeout(function(){$("#rg2-container").show()},500)}function b(){try{"localStorage"in window&&null!==window.localStorage&&null!==localStorage.getItem("rg2-options")&&(Rb=JSON.parse(localStorage.getItem("rg2-options")),Rb.circleSize=20,0===Rb.mapIntensity&&rg2WarningDialog("Warning","Your saved settings have 0% map intensity so the map is invisible. You can adjust this on the configuration menu"))}catch(a){console.log("Local storage not supported")}}function c(a){return lb.hasOwnProperty(a)?lb[a]:a}function d(){var a;$("#rg2-events-tab a").text(c("Events")),$("#rg2-courses-tab a").text(c("Courses")),$("#rg2-results-tab a").text(c("Results")),$("#rg2-draw-tab a").text(c("Draw")),$("#rg2-hide-info-panel-icon").prop("title",c("Hide info panel")),$("#btn-about").prop("title",c("Help")),$("#btn-options").prop("title",c("Options")),$("#btn-zoom-out").prop("title",c("Zoom out")),$("#btn-zoom-in").prop("title",c("Zoom in")),$("#btn-reset").prop("title",c("Reset")),$("#btn-show-splits").prop("title",c("Splits")),a=$("#btn-toggle-controls").prop("title"),$("#btn-toggle-controls").prop("title",c(a)),a=$("#btn-toggle-names").prop("title"),$("#btn-toggle-names").prop("title",c(a)),$("#rg2-splits-table").prop("title",c("Splits table")),$("#btn-slower").prop("title",c("Slower")),$("#btn-faster").prop("title",c("Faster")),a=$("#btn-start-stop").prop("title"),$("#btn-start-stop").prop("title",c(a)),$("#btn-real-time").prop("title",c("Real time")),$("#btn-mass-start").prop("title",c("Mass start")),$("label[for=rg2-control-select]").prop("textContent",c("Start at")),$("label[for=btn-full-tails]").prop("textContent",c("Full tails")),$("label[for=spn-tail-length]").prop("textContent",c("Length")),$(".rg2-options-dialog .ui-dialog-title").text(c("Configuration options")),$("label[for=rg2-select-language]").prop("textContent",c("Language")),$("label[for=spn-map-intensity]").prop("textContent",c("Map intensity %")),$("label[for=spn-route-intensity]").prop("textContent",c("Route intensity %")),$("label[for=spn-route-width]").prop("textContent",c("Route width")),$("label[for=spn-name-font-size]").prop("textContent",c("Replay label font size")),$("label[for=spn-course-width]").prop("textContent",c("Course overprint width")),$("label[for=spn-control-circle]").prop("textContent",c("Control circle size")),$("label[for=chk-snap-toggle]").prop("textContent",c("Snap to control when drawing")),$("label[for=chk-show-three-seconds]").prop("textContent",c("Show +3 time loss for GPS routes")),$("label[for=chk-show-GPS-speed]").prop("textContent",c("Show GPS speed colours")),$("#btn-undo").button("option","label",c("Undo")),$("#btn-undo-gps-adjust").button("option","label",c("Undo")),$("#btn-save-route").button("option","label",c("Save")),$("#btn-reset-drawing").button("option","label",c("Reset")),$("#btn-three-seconds").button("option","label",c("+3 sec")),$("#btn-save-gps-route").button("option","label",c("Save GPS route")),$("#rg2-draw-title").text(c("Draw route")),$("#draw-text-1").text(c("Left click to add/lock/unlock a handle")),$("#draw-text-2").text(c("Green - draggable")),$("#draw-text-3").text(c("Red - locked")),$("#draw-text-4").text(c("Right click to delete a handle")),$("#draw-text-5").text(c("Drag a handle to adjust track around locked point(s)")),$("#rg2-load-gps-title").text(c("Load GPS file (GPX or TCX)")),$("label[for=rg2-course-select]").prop("textContent",c("Select course")),$("label[for=rg2-name-select]").prop("textContent",c("Select name")),$("label[for=btn-move-all]").prop("textContent",c("Move track and map together (or right click-drag)"))}function e(){$("#rg2-select-language").empty();var a,b,c=document.getElementById("rg2-select-language");b=document.createElement("option"),b.value="en",b.text="en: English","en"===lb.code&&(b.selected=!0),c.options.add(b);for(a in rg2Config.languages)b=document.createElement("option"),b.value=a,b.text=a+": "+rg2Config.languages[a],lb.code===a&&(b.selected=!0),c.options.add(b)}function f(a){$.getJSON(rg2Config.json_url,{id:a,type:"lang",cache:!1}).done(function(a){lb=a.data,g()}).fail(function(a,b,c){var d=b+", "+c;console.log("Language request failed: "+d)})}function g(){$("#rg2-event-list").menu("destroy"),s();var a=ob.getActiveEventID();null!==a&&(pb.removeAllFromDisplay(),qb.removeAllTracksFromDisplay(),tb.resetAnimation(),vb.initialiseDrawing(ob.hasResults(a)),y(),z()),d(),Mb.tabs("refresh"),m(!1)}function h(){$.getJSON(rg2Config.json_url,{type:"events",cache:!1}).done(function(a){if(console.log("Events: "+a.data.length),ob.deleteAllEvents(),$.each(a.data,function(){ob.addEvent(new Event(this))}),s(),Kb){var b=ob.getEventIDForKartatID(Kb);void 0!==b&&t(b)}Lb&&ub.eventListLoaded()}).fail(function(a,b,c){var d=b+", "+c;console.log("Events request failed: "+d)})}function i(){j(),Lb&&ub.mapLoadCallback()}function j(){var a,b=Ob.height/mb.height;yb=Ob.width/2,zb=Ob.height/2,Ab=1,Bb=null,Cb=!0,a=1>b?b:1,wb||window.innerWidth>=Qb.BIG_SCREEN_BREAK_POINT?Pb.setTransform(a,0,0,a,Mb.outerWidth(),0):Pb.setTransform(a,0,0,a,0,0),Pb.save(),m(!1)}function k(){xb=Qb.DEFAULT_SCALE_FACTOR;var a=window.innerWidth,b=window.innerHeight;$("#rg2-container").css("height",b-36),Ob.width=a,Ob.height=b-36,u(),j()}function l(){var a=Mb.tabs("option","active");switch(a){case Qb.TAB_DRAW:pb.removeAllFromDisplay(),vb.showCourseInProgress()}m(!1)}function m(a){if(Pb.save(),Pb.setTransform(1,0,0,1,0,0),Pb.fillStyle=Qb.WHITE,Pb.fillRect(0,0,Pb.canvas.width,Pb.canvas.height),Pb.restore(),Pb.globalAlpha=Rb.mapIntensity/100,mb.height>0){Pb.drawImage(mb,0,0);var b=Mb.tabs("option","active");b===Qb.TAB_DRAW?(pb.drawCourses(Qb.DIM),rb.drawControls(!1),qb.drawTracks(),vb.drawNewTrack()):b===Qb.TAB_CREATE?ub.drawControls():(pb.drawCourses(Qb.FULL_INTENSITY),qb.drawTracks(),rb.drawControls(!1),a?tb.runAnimation(!0):tb.runAnimation(!1))}else Pb.font="30pt Arial",Pb.textAlign="center",Pb.fillStyle=Qb.BLACK,Pb.fillText(c(nb),Ob.width/2,Ob.height/2)}function n(){$("#rg2-event-stats").empty().html(r()),$("#rg2-about-dialog").dialog({width:Math.min(1e3,.8*Ob.width),maxHeight:Math.min(1e3,.9*Ob.height),title:"RG2 Version "+Qb.RG2VERSION,resizable:!1,buttons:{Ok:function(){$(this).dialog("close")}}})}function o(){$("#rg2-option-controls").dialog({minWidth:400,title:c("Configuration options"),dialogClass:"rg2-options-dialog",close:function(){p()}})}function p(){try{"localStorage"in window&&null!==window.localStorage&&(Rb.snap=$("#chk-snap-toggle").prop("checked"),Rb.showThreeSeconds=$("#chk-show-three-seconds").prop("checked"),Rb.showGPSSpeed=$("#chk-show-GPS-speed").prop("checked"),localStorage.setItem("rg2-options",JSON.stringify(Rb)))}catch(a){return}}function q(){wb?(wb=!1,$("#rg2-resize-info").prop("title",c("Show info panel")),$("#rg2-hide-info-panel-control").css("left","0px"),$("#rg2-hide-info-panel-icon").removeClass("fa-chevron-left").addClass("fa-chevron-right").prop("title",c("Show info panel")),Mb.hide()):(wb=!0,$("#rg2-resize-info").prop("title",c("Hide info panel")),$("#rg2-hide-info-panel-control").css("left","366px"),$("#rg2-hide-info-panel-icon").removeClass("fa-chevron-right").addClass("fa-chevron-left").prop("title",c("Hide info panel")),Mb.show()),j()}function r(){var a,b,d;return null===ob.getActiveEventID()?"":(b=pb.getCoursesForEvent(),d=qb.getResultsInfo(),a="<h3>"+c("Event statistics")+"</h3>",a+="<p><strong>"+c("Courses")+":</strong> "+b.length+" <strong>"+c("Results")+":</strong> "+d.results,a+="<strong> "+c("Drawn routes")+":</strong> "+d.drawnroutes+" <strong>"+c("GPS routes"),a+=":</strong> "+d.gpsroutes+" ("+d.percent+"%)</p>",a+="<p><strong>"+c("Total time")+":</strong> "+d.time+"</p>",a+="<p><strong>"+c("Map ")+":</strong> ID "+ob.getActiveMapID()+", "+mb.width+" x "+mb.height+" pixels </p>",a+="<p><strong>"+c("Comments")+":</strong></p>",a+=qb.getComments())}function s(){var a=ob.formatEventsAsMenu();$("#rg2-event-list").append(a).menu({select:function(a,b){t(b.item[0].id)}})}function t(a){$("#rg2-event-list > li").removeClass("rg2-active-event").filter("#"+a).addClass("rg2-active-event"),$("body").css("cursor","wait"),$("#rg2-load-progress-label").text(c("Loading courses")),$("#rg2-load-progress").show(),pb.deleteAllCourses(),rb.deleteAllControls(),tb.resetAnimation(),qb.deleteAllResults(),ob.setActiveEventID(a),vb.initialiseDrawing(ob.hasResults(a)),v(rg2Config.maps_url+ob.getActiveMapID()+".jpg"),m(!1),u(),$.getJSON(rg2Config.json_url,{id:ob.getKartatEventID(),type:"courses",cache:!1}).done(function(a){$("#rg2-load-progress-label").text(c("Saving courses")),console.log("Courses: "+a.data.length),$.each(a.data,function(){pb.addCourse(new Course(this,ob.isScoreEvent()))}),pb.updateCourseDropdown(),pb.generateControlList(rb),$("#btn-toggle-controls").show(),$("#btn-toggle-names").show(),w()}).fail(function(a,b,c){$("body").css("cursor","auto"),$("#rg2-load-progress").hide();var d=b+", "+c;console.log("Courses request failed: "+d)})}function u(){var a;window.innerWidth>=Qb.BIG_SCREEN_BREAK_POINT?(a=ob.getActiveEventName()+" "+ob.getActiveEventDate(),Nb.html(a).show()):window.innerWidth>Qb.SMALL_SCREEN_BREAK_POINT?(a=ob.getActiveEventName(),Nb.html(a).show()):Nb.hide(),ob.mapIsGeoreferenced()?$("#rg2-event-title-icon").addClass("fa fa-globe"):$("#rg2-event-title-icon").removeClass("fa fa-globe")}function v(a){nb="Loading map",mb.src=a}function w(){$("#rg2-load-progress-label").text(c("Loading results")),$.getJSON(rg2Config.json_url,{id:ob.getKartatEventID(),type:"results",cache:!1}).done(function(a){console.log("Results: "+a.data.length),$("#rg2-load-progress-label").text(c("Saving results"));var b=ob.isScoreEvent();qb.addResults(a.data,b),pb.setResultsCount(),b&&(rb.deleteAllControls(),qb.generateScoreCourses(),pb.generateControlList(rb)),$("#rg2-result-list").accordion("refresh"),x()}).fail(function(a,b,c){$("body").css("cursor","auto");var d=b+", "+c;console.log("Results request failed: "+d),$("#rg2-load-progress").hide()})}function x(){$("#rg2-load-progress-label").text(c("Loading routes")),$.getJSON(rg2Config.json_url,{id:ob.getKartatEventID(),type:"tracks",cache:!1}).done(function(a){if($("#rg2-load-progress-label").text(c("Saving routes")),console.log("Tracks: "+a.data.length),qb.addTracks(a.data),y(),z(),tb.updateAnimationDetails(),$("body").css("cursor","auto"),Lb)ub.eventFinishedLoading();else{Mb.tabs("enable",Qb.TAB_COURSES),Mb.tabs("enable",Qb.TAB_RESULTS),Mb.tabs("enable",Qb.TAB_DRAW);var b=Mb.tabs("option","active");b!==Qb.TAB_DRAW&&Mb.tabs("option","active",Qb.TAB_COURSES),Mb.tabs("refresh"),$("#btn-show-splits").show(),rg2Config.enable_splitsbrowser&&ob.hasResults()?$("#rg2-splitsbrowser").off().click(function(){window.open(rg2Config.json_url+"?type=splitsbrowser&id="+ob.getKartatEventID())}).show():$("#rg2-splitsbrowser").off().hide()}$("#rg2-load-progress-label").text(""),$("#rg2-load-progress").hide(),m(!1)}).fail(function(a,b,c){$("body").css("cursor","auto");var d=b+", "+c;console.log("Tracks request failed: "+d),$("#rg2-load-progress").hide()})}function y(){$("#rg2-course-table").empty().append(pb.formatCoursesAsTable()),$(".courselist").click(function(a){a.target.checked?pb.putOnDisplay(parseInt(a.currentTarget.id,10)):(pb.removeFromDisplay(parseInt(a.currentTarget.id,10)),$(".allcourses").prop("checked",!1)),m(!1)}),$(".allcourses").click(function(a){a.target.checked?(pb.putAllOnDisplay(),$(".courselist").prop("checked",!0)):(pb.removeAllFromDisplay(),$(".courselist").prop("checked",!1)),m(!1)}),$(".tracklist").click(function(a){var b=a.target.id;a.target.checked?qb.putTracksOnDisplay(b):(qb.removeTracksFromDisplay(b),$(".alltracks").prop("checked",!1)),m(!1)}),$(".alltracks").click(function(a){a.target.checked?(qb.putAllTracksOnDisplay(),$(".tracklist").prop("checked",!0)):(qb.removeAllTracksFromDisplay(),$(".tracklist").prop("checked",!1)),m(!1)})}function z(){var a=qb.formatResultListAsAccordion();$("#rg2-result-list").empty().append(a),$("#rg2-result-list").accordion("refresh"),Mb.tabs("refresh"),$(".showcourse").click(function(a){a.stopPropagation(),a.target.checked?pb.putOnDisplay(a.target.id):pb.removeFromDisplay(a.target.id),m(!1)}),$(".showscorecourse").click(function(a){qb.displayScoreCourse(parseInt(a.target.id,10),a.target.checked),m(!1)}),$(".showtrack").click(function(a){a.target.checked?qb.putOneTrackOnDisplay(a.target.id):qb.removeOneTrackFromDisplay(a.target.id),m(!1)}),$(".showreplay").click(function(a){a.target.checked?tb.addRunner(new Runner(parseInt(a.target.id,10)),!0):tb.removeRunner(parseInt(a.target.id,10),!0),m(!1)}),$(".allcoursetracks").click(function(a){var b,c;b=qb.getAllRunnersForCourse(parseInt(a.target.id,10));var d;for(d=0;d<b.length;d+=1)a.target.checked?qb.putOneTrackOnDisplay(b[d]):qb.removeOneTrackFromDisplay(b[d]);c=".showtrack-"+a.target.id,a.target.checked?$(c).prop("checked",!0):$(c).prop("checked",!1),m(!1)}),$(".allcoursereplay").click(function(a){var b,c;b=qb.getAllRunnersForCourse(parseInt(a.target.id,10)),tb.animateRunners(b,a.target.checked),c=".showreplay-"+a.target.id,a.target.checked?$(c).prop("checked",!0):$(c).prop("checked",!1),m(!1)}),0===pb.getHighestControlNumber()?$("#rg2-control-select").prop("disabled",!0):$("#rg2-control-select").prop("disabled",!1)}function A(a){return pb.getFullCourse(a)}function B(a){return pb.getCourseName(a)}function C(a){return qb.countResultsByCourseID(a)}function D(a,b,c,d,e){return rb.drawStart(a,b,c,d,e)}function E(a,b,c,d){return rb.drawSingleControl(a,b,c,d)}function F(a,b,c,d){return rb.drawFinish(a,b,c,d)}function G(a){return qb.getFullResult(a)}function H(){return pb.getHighestControlNumber()}function I(a){return ob.getKartatEventID(a)}function J(){return ob.hasResults()}function K(a){return pb.incrementTracksCount(a)}function L(a){pb.putOnDisplay(a)}function M(a,b){qb.putScoreCourseOnDisplay(a,b)}function N(a){pb.removeFromDisplay(a)}function O(a){qb.createNameDropdown(a)}function P(a){return qb.getRunnerName(a)}function Q(a){return qb.resultIDExists(a)}function R(a){return qb.getTimeForID(a)}function S(a){return qb.getSplitsForID(a)}function T(){return ob.mapIsGeoreferenced()}function U(){var a={};return a.height=mb.height,a.width=mb.width,a}function V(){return ob.getWorldFile()}function W(){return vb.getControlX()}function X(){return vb.getControlY()}function Y(){return ob.getActiveEventID()}function Z(){ob.createEventEditDropdown()}function _(){return Rb.routeWidth}function ab(){var a={};return a.controlRadius=Rb.circleSize,a.finishInnerRadius=Rb.circleSize*(5/6),a.finishOuterRadius=Rb.circleSize*(7/6),a.startTriangleLength=Rb.circleSize*(7/6),a.overprintWidth=Rb.courseWidth,a.font=Rb.circleSize+"pt Arial",a}function bb(){return Rb.routeIntensity/100}function cb(){return Rb.replayFontSize}function db(){return $("#chk-show-three-seconds").prop("checked")}function eb(){return $("#chk-show-GPS-speed").prop("checked")}function fb(a){return ob.getEventInfo(a)}function gb(){return pb.getCoursesForEvent()}function hb(){return qb.getRoutesForEvent()}function ib(){return sb.getNextColour()}function jb(a,b,c,d){pb.updateScoreCourse(a,b,c,d)}function kb(){return Rb.snap}var lb,mb,nb,ob,pb,qb,rb,sb,tb,ub,vb,wb,xb,yb,zb,Ab,Bb,Cb,Db,Eb,Fb,Gb,Hb,Ib,Jb,Kb,Lb,Mb,Nb,Ob=$("#rg2-map-canvas")[0],Pb=Ob.getContext("2d"),Qb={DEFAULT_SCALE_FACTOR:1.1,TAB_EVENTS:0,TAB_COURSES:1,TAB_RESULTS:2,TAB_DRAW:3,TAB_LOGIN:4,TAB_CREATE:5,TAB_EDIT:6,TAB_MAP:7,DEFAULT_NEW_COMMENT:"Type your comment",DEFAULT_EVENT_COMMENT:"Comments (optional)",GPS_RESULT_OFFSET:5e4,MASS_START_REPLAY:1,REAL_TIME_REPLAY:2,MASS_START_BY_CONTROL:99999,VERY_HIGH_TIME_IN_SECS:99999,BIG_SCREEN_BREAK_POINT:800,SMALL_SCREEN_BREAK_POINT:500,PURPLE:"#b300ff",RED:"#ff0000",GREEN:"#00ff00",WHITE:"#ffffff",BLACK:"#ffoooo",RUNNER_DOT_RADIUS:6,DIM:.75,FULL_INTENSITY:1,NORMAL_EVENT:1,EVENT_WITHOUT_RESULTS:2,SCORE_EVENT:3,RG2VERSION:"0.8.5",TIME_NOT_FOUND:9999,SPLITS_NOT_FOUND:9999,RIGHT_CLICK:3},Rb={mapIntensity:100,routeIntensity:100,replayFontSize:12,courseWidth:3,routeWidth:4,circleSize:20,snap:!0,showThreeSeconds:!1,showGPSSpeed:!1},Sb=function(a){a.preventDefault(),a.touches.length>1&&(Fb=Pb.transformedPoint(a.touches[0].pageX,a.touches[0].pageY),Gb=Pb.transformedPoint(a.touches[1].pageX,a.touches[1].pageY),Eb=!0),yb=a.touches[0].pageX,zb=a.touches[0].pageY,$b(a)},Tb=function(a){var b,c;a.touches.length>1?Eb||(Fb=Pb.transformedPoint(a.touches[0].pageX,a.touches[0].pageY),Gb=Pb.transformedPoint(a.touches[1].pageX,a.touches[1].pageY),Eb=!0):Eb=!1,Eb&&a.touches.length>1?(Hb=Pb.transformedPoint(a.touches[0].pageX,a.touches[0].pageY),Ib=Pb.transformedPoint(a.touches[1].pageX,a.touches[1].pageY),b=getDistanceBetweenPoints(Fb.x,Fb.y,Gb.x,Gb.y),c=getDistanceBetweenPoints(Hb.x,Hb.y,Ib.x,Ib.y),b/c>1.1?(Vb(-1),Fb=Hb,Gb=Ib):.9>b/c&&(Vb(1),Fb=Hb,Gb=Ib)):(yb=a.touches[0].pageX,zb=a.touches[0].pageY,_b(a))},Ub=function(a){ac(a),Eb=!1},Vb=function(a){var b=Math.pow(xb,a),c=Ab*b;if(50>c&&c>.05){Ab=c;var d=Pb.transformedPoint(yb,zb);Pb.translate(d.x,d.y),Pb.scale(b,b),Pb.translate(-d.x,-d.y),Pb.save(),m(!1)}},Wb=function(a){var b=a.wheelDelta?a.wheelDelta/40:a.detail?-a.detail:0;return b&&Vb(b),a.stopPropagation(),a.preventDefault()&&!1},Xb=function(a){return yb=a.offsetX||a.layerX-Ob.offsetLeft,zb=a.offsetY||a.layerY-Ob.offsetTop,$b(a),a.stopPropagation(),a.preventDefault()&&!1},Yb=function(a){return yb=a.offsetX||a.layerX-Ob.offsetLeft,zb=a.offsetY||a.layerY-Ob.offsetTop,_b(a),a.stopPropagation(),a.preventDefault()&&!1},Zb=function(a){return ac(a),a.stopPropagation(),a.preventDefault()&&!1},$b=function(a){Bb=Pb.transformedPoint(yb,zb),Cb=!1,Db=a.which},_b=function(a){if(Bb){var b=Pb.transformedPoint(yb,zb);Math.abs(b.x-Bb.x)+Math.abs(b.y-Bb.y)>5&&(vb.gpsFileLoaded()?vb.adjustTrack(Math.round(Bb.x),Math.round(Bb.y),Math.round(b.x),Math.round(b.y),Db,a.shiftKey,a.ctrlKey):Mb.tabs("option","active")===Qb.TAB_CREATE?ub.adjustControls(Math.round(Bb.x),Math.round(Bb.y),Math.round(b.x),Math.round(b.y),Db,a.shiftKey,a.ctrlKey):Pb.translate(b.x-Bb.x,b.y-Bb.y),Cb=!0,m(!1))}},ac=function(a){var b=Mb.tabs("option","active");Cb?b===Qb.TAB_CREATE?ub.dragEnded():vb.dragEnded():b===Qb.TAB_CREATE?ub.mouseUp(Math.round(Bb.x),Math.round(Bb.y)):vb.mouseUp(Math.round(Bb.x),Math.round(Bb.y),a.which),Bb=null,m(!1)};return{t:c,init:a,config:Qb,options:Rb,redraw:m,getOverprintDetails:ab,getRouteWidth:_,getRouteIntensity:bb,getReplayFontSize:cb,ctx:Pb,getMapSize:U,loadNewMap:v,loadEvent:t,loadEventList:h,eventHasResults:J,mapIsGeoreferenced:T,getWorldFile:V,getFullResult:G,drawStart:D,drawSingleControl:E,drawFinish:F,getTimeForID:R,getSplitsForID:S,resultIDExists:Q,getRunnerName:P,putOnDisplay:L,putScoreCourseOnDisplay:M,removeFromDisplay:N,createNameDropdown:O,incrementTracksCount:K,getKartatEventID:I,getActiveEventID:Y,getHighestControlNumber:H,getCourseDetails:A,getCourseName:B,countResultsByCourseID:C,getControlX:W,getControlY:X,createEventEditDropdown:Z,showThreeSeconds:db,showGPSSpeed:eb,getEventInfo:fb,getCoursesForEvent:gb,getRoutesForEvent:hb,getNextRouteColour:ib,updateScoreCourse:jb,getSnapToControl:kb}
