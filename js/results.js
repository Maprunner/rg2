...
(function () {
  ...
  Results.prototype = {
    ...
    getCourseHeader : function (result) {
      ...
      html += "<div class='input-group margin-bottom-sm'><span class='input-group-addon'><i class='fa fa-search fa-fw'></i></span><input type='text' class='form-control' id='" + result.coursename + "' placeholder='" + rg2.t("Search") + "'></div>";
      html += "<div class='input-group margin-bottom-sm'><span class='input-group-addon'><i class='fa fa-search fa-fw'></i></span><input type='text' class='form-control rg2-result-search' id='" + result.coursename + "' placeholder='" + rg2.t("Search") + "'></div>";
